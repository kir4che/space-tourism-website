...
const Destination: React.FC = () => {
  ...
  return (
    <div className='relative min-h-screen bg-cover bg-desktop-destination tablet:bg-tablet-destination tablet:text-center mobile:bg-mobile-destination'>
      <Header />
      <h6 className='absolute text-white top-32 left-36 tablet:relative tablet:top-36 tablet:left-0 tablet:-mt-20 tablet:-mb-64 mobile:left-0 mobile:-mt-24 mobile:-mb-80 mobile:scale-75'><b className='text-white/30'>01</b>　PICK YOUR DESTINATION</h6>
      <div className='flex items-end justify-around tablet:flex-col tablet:justify-center tablet:items-center tablet:mt-64 tablet:scale-90 mobile:scale-75'>
        ...
        <div>
          ...
          <div className='flex mt-8 space-x-20 tablet:justify-around mobile:flex-col mobile:-mb-10 mobile:space-x-0 mobile:space-y-8'>
            <div>
              <p>AVG. DISTANCE</p>
